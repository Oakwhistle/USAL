/* Fuente: TEXTO3.C
   ...
   El programa utiliza una segunda función FijarTexto para formater el array recibido para que todas
   las líneas tengan la longitud de la máxima línea, completando las líneas que sean necesarias con
   un carácter que se le pasará también como parámetro a la función.
*/
...
/* ---------------------------------------------------------- */
     ...
     puts("variable. El programa utiliza la función FijarTexto con prototipo          ");
     puts("");
     puts("             void FijarTexto (char **txt, int nlin, char c);               ");
     puts("");
     puts("para completar todas las líneas a la longitud de la mayor.                 ");
     puts("");
}
